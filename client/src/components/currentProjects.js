...
function CurrentProjects() {
  ...
  const findTemplate = (id) => {
    ...
    templates.templates.forEach((elem) =>
      elem.template_id === id ? (matchedTemp = elem) : null
    );
    return matchedTemp;
  };
  ...
  return (
    <PageContainer pageTitle="Active projects" buttonText="Close" buttonTo="/">
      <section>
        <Accordion>
                  ...
                  <Accordion.Header>
                    <div className="current-projects-header-info">
                      <div className="project-header-info">
                        ...
                        <div className="project-id">Project ID: {proj._id}</div>
                      </div>
                    ...
                    <div className="project-date-info">
                      <div>
                        <p>
                          ...
                          {new Date(proj.time_start * 1000).toLocaleString()}
                        </p>
                      </div>
                      <div>
                        <p>
                          <strong>Deadline:</strong>{" "}
                          {new Date(proj.time_deadline * 1000).toLocaleString()}
                        </p>
                      </div>
                    </div>
                    <p>
